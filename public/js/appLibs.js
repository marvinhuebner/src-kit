...
!function ($) {
	 ...
	 */var Reveal = function () {
		 ...
		 */_createClass(Reveal, [{
			...
			key: '_makeOverlay', value: function _makeOverlay(id) {
			...
			key: '_updatePosition', value: function _updatePosition() {
				...
				this.$element.css({top: top + 'px'});// only worry about left if we don't have an overlay or we havea  horizontal offset,
// otherwise we're perfectly in the middle
			...
			key: '_handleState', value: function _handleState(e) {
				...
				if (this.options.animationIn) {
					...
					(function () {
						var afterAnimationFocus = function afterAnimationFocus() {
							_this.$element.attr({'aria-hidden': false, 'tabindex': -1}).focus();
							console.log('focus');
						};
						_this = _this3;
	...
	var myStupidMarvinVar = function myStupidMarvinVar() {
		console.log('asdf');
	};
}(jQuery);
//# sourceMappingURL=libBabel.js.map
