...
!function (a, b) {
    ...
    var c = [], d = a.document, e = c.slice, f = c.concat, g = c.push, h = c.indexOf, i = {}, j = i.toString, k = i.hasOwnProperty, l = {}, m = "2.2.3", n = function n(a, b) {
    ...
    n.fn = n.prototype = {
        ...
        expando: "jQuery" + (m + Math.random()).replace(/\D/g, ""), isReady: !0, error: function error(a) {
            throw new Error(a);
        }, noop: function noop() {
    ...
    var t = function (a) {
        ...
        function xa(a, b) {
            var c = b.length > 0, e = a.length > 0, f = function f(_f, g, h, i, k) {
                var l, o, q, r = 0, s = "0", t = _f && [], u = [], v = j, x = _f || e && d.find.TAG("*", k), y = w += null == v ? 1 : Math.random() || .1, z = x.length;
    ...
    var S = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, T = new RegExp("^(?:([+-])=|)(" + S + ")([a-z%]*)$", "i"), U = ["Top", "Right", "Bottom", "Left"], V = function V(a, b) {
    ...
    n.extend({
        ...
        domManip: ua, detach: function detach(a) {
            return va(this, a, !0);
    ...
    var Aa = /^margin/, Ba = new RegExp("^(" + S + ")(?!px)[a-z%]+$", "i"), Ca = function Ca(b) {
    ...
    n.Tween = Ra, Ra.prototype = {
        constructor: Ra, init: function init(a, b, c, d, e, f) {
    ...
    n.fn.load = function (a, b, c) {
        ...
        return h > -1 && (d = n.trim(a.slice(h)), a = a.slice(0, h)), n.isFunction(b) ? (c = b, b = void 0) : b && "object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) && (e = "POST"), g.length > 0 && n.ajax({
            url: a,
            type: e || "GET",
            dataType: "html",
            data: b
...
// - the old one won't work if passed to addEventListener directly.
     ...
     */FastClick.prototype.needsClick = function (target) {
        switch (target.nodeName.toLowerCase()) { // Don't send a synthetic click to disabled inputs (issue #62)
            case 'button':
            case 'select':
            case 'textarea':
                if (target.disabled) {
    ...
    FastClick.prototype.determineEventType = function (targetElement) { //Issue #159: Android Chrome Select Box does not open with a synthetic click event
...
// target element was moved to another parent.
     ...
     */FastClick.prototype.onTouchStart = function (event) {
        ...
        if (deviceIsIOS) { // Only trusted events will deselect text on iOS (issue #49)
            selection = window.getSelection();
            if (selection.rangeCount && !selection.isCollapsed) {
                return true;
            }
            if (!deviceIsIOS4) { // Weird things happen on iOS when an alert or confirm dialog is opened from a click event callback (issue #23):
...
// Also this breaks opening selects when VoiceOver is active on iOS6, iOS7 (and possibly others)
        ...
        if (deviceIsIOS && !deviceIsIOS4) { // Don't send a synthetic click event if the target element is contained within a parent layer that was scrolled
     ...
     */FastClick.notNeeded = function (layer) {
        ...
        if (chromeVersion) {
            if (deviceIsAndroid) {
                ...
                if (metaViewport) { // Chrome on Android with user-scalable="no" doesn't need FastClick (issue #89)
...
// https://github.com/ftlabs/fastclick/issues/251
            if (blackberryVersion[1] >= 10 && blackberryVersion[2] >= 3) {
                metaViewport = document.querySelector('meta[name=viewport]');
                if (metaViewport) { // user-scalable=no eliminates click delay.
                    if (metaViewport.content.indexOf('user-scalable=no') !== -1) {
                        return true;
        ...
        if (firefoxVersion >= 27) { // Firefox 27+ does not have tap delay if the content is not zoomable - https://bugzilla.mozilla.org/show_bug.cgi?id=922896
            metaViewport = document.querySelector('meta[name=viewport]');
...
// http://msdn.microsoft.com/en-us/library/windows/apps/Hh767313.aspx
    ...
    if (typeof define === 'function' && _typeof(define.amd) === 'object' && define.amd) { // AMD. Register as an anonymous module.
        define(function () {
            return FastClick;
        });
...
$(document).ready(function () {
    ...
    if (currentBreakpoint == 'small') { // your code
    }
    if (currentBreakpoint == 'medium') { // your code
    }
    if (currentBreakpoint == 'large') { // your code
    }
